    ...
    if (isset($_GET['action'])) {
        if ($_GET['action'] == "review") {
            ...
            if ($result) {
                ...
                echo '<meta http-equiv="refresh" content="0; URL=pet.php?id=' . $pet_id . '" />';
                exit();
            } else {
...
<div class="container bg-white my-4 p-5 rounded-4">
    <div class="row gy-3 align-items-center">
        ...
        <div class="col-md-6">
            ...
            <!-- added by -->
            <p class="product-category">
                <strong>Added by:</strong> <?php echo getVendorNameById('pets',$pet['pet_id']); ?>
            </p>
    ...
    <div class="row gy-3 mt-5">
        <h3>Add a Review</h3>
        <form action="pet.php?action=review&id=<?php echo $pet['pet_id']; ?>" method="POST">
